...
async def on_startup():
    ...
    db_path = os.path.join(os.path.dirname(__file__), 'database.sqlite')
    users_data = [
        (652050168, "Грейчуте", 2500),
        (782951816, "Ostin", None),
        (810913382, "Sultan", 2500),
        (942955764, "RR", 1563),
        (995527468, "Тамерлан", 2500),
        (1272801876, "bagatyann🇯🇵", 16481),
        (1326080172, "Danochka🤍", 2500),
        (1359649738, "🩸", 2500),
        (1436279311, "Земфира", 2500),
        (1462634005, "бельмø", 2500),
        (1626738416, "DDD", None),
        (2007352974, "🇨🇺🌿", 2500),
        (5175520249, "Omirzhan", 2500),
        (5195664342, "p?te₽gr/ff!n", 2500),
        (5478095919, "Уша", 2500),
        (6389268882, "hevoneloww", 670928),
        (6460792708, "q", None),
        (6783355911, "feizu", 119909),
        (7017562552, "🦁", 22069),
        (7049629543, "ZloyZerbuV", 2500),
        (7630727268, "regretful", 4563),
        (8025033238, "BEKA", 18855),
        (8107364556, "SplashTraffic", 17966),
        (8283038522, "👅", 2500),
        (8599896666, "ㅤ", 2500),
        (8615265789, "Sezim", 18012),
        (8952271007, "Жасик", None),
    ]
    try:
        conn = sqlite3.connect(db_path)
        cursor = conn.cursor()
